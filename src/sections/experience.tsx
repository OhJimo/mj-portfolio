      ...
      <div className="container-portfolio">
        ...
        <div className="mt-16 space-y-12 md:mt-20 md:flex md:flex-col md:gap-[40vh] md:space-y-0 md:pb-[30vh] lg:mt-24">
          {CARDS.map((card, i) => (
            ...
            >
              <article className="shadow-subtle rounded-2xl border border-border bg-card p-8 transition-shadow duration-300 hover:shadow-md md:p-10 lg:p-12">
                <p className="text-sm font-medium text-muted-foreground">
                  {card.number}
                </p>
                <h3 className="mt-4 text-[clamp(1.5rem,3vw,2.25rem)] font-bold leading-[1.3] tracking-tight">
                  {card.title}
                </h3>
